...
public abstract class MessageEvent extends ExternalEvent {
     ...
     *            ID of the message
     * @param time
     *            Time when the message event occurs
     * @param prio
     *            Priority of the message
     */
    ...
    /**
     * Creates a message event. Uses the same parameters as the previous
     * constructor, but the priority. Calls the previous constructor with the
     * INVALID_PRIORITY.
     */

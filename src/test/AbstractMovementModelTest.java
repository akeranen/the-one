...
public abstract class AbstractMovementModelTest {
    ...
    @Before
    /**
     * Initializes the settings, sets the locale to US and gets the initial location,
     * so getPath works. Needs {@link #initializeModel(TestSettings)}.
     */
    public void setUp(){
        Settings.init(null);
    ...
    /**
     * Tests if paths generated by the MovementModel stay within the bounds
